...
class DelTaxi extends JFrame implements ActionListener
{
JFrame f;
Container cn;
JPanel p1;
...
JButton b1,b2,b3;
	...
	public void setup()
		...
		l.setIcon(i);
                       ...
                       l1=new JLabel("REMOVE       TAXI      RECORDS");
				...
				if(e.getSource().equals(b1))
					{
						...
						pstmt=conn.prepareStatement(" Delete from Taxi where TaxiID = ? " );
