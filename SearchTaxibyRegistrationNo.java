...
class SearchTaxibyRegistrationNo extends JFrame implements ActionListener {
...
//Labels..... 
			 ...
			 l5=new JLabel("PRICE :");
			 l6=new JLabel("ENTER  REGISTRATION  NO :");
			 ...
			 l2.setBounds(580,150,100,30);
			 l3.setBounds(940,450,100,30);
			 l4.setBounds(940,150,100,30);
			 l5.setBounds(580,300,100,30);
			 l6.setBounds(200,150,200,30);
...
//Text Fields........                      		
			...
			t8.setEditable(false);
                        ...
                        t1.setBounds(580,180,240,30);
			t2.setBounds(940,480,240,30);
			t4.setBounds(580,330,240,30);
			t5.setBounds(200,180,240,30);
				...
				if(e.getSource().equals(b1))
					{
					 	try
						{
						 ...
						 String q;
						 String jk ="where RegistrationNo ="+t5.getText();
...
public static void main(String args[])
	{
	SearchTaxibyRegistrationNo t=new  SearchTaxibyRegistrationNo();
	t.setup();
	}
}     	 
