...
class SearchDriverbyId extends JFrame implements ActionListener {
		...
		public void actionPerformed(ActionEvent e)
			{
				if(e.getSource().equals(b1))
				 ...
				 stmt=conn.createStatement();
						 ...
						 q="select DriverID,Name,Gender,PhoneNo,LicenceNo,AdharNo,Address,Experience,DateOfJoin,DateOfBirth,BloodGroup from Driver " + jk;
						 rs=stmt.executeQuery(q);
						 if(rs.next())
							{
