...
class SearchDriverbyName extends JFrame implements ActionListener {
...
//Labels........
		...
		l3.setBounds(200,140,120,20);
		l2.setBounds(580,140,100,20);
...
//Text Fields........				
		...
		t11.setEditable(false);
                 ...
                 t2.setBounds(200,160,240,30);
		 t1.setBounds(580,160,240,30);
		...
		public void actionPerformed(ActionEvent e)
			{
				if(e.getSource().equals(b1))
					...
					String str2 = t2.getText(); 
						...
						PreparedStatement ps = conn.prepareStatement("Select * from Driver where Name=?");
						ps.setString(1,str2);
